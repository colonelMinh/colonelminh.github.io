...
document.getElementById("ai-copilot-btn").onclick = function() {
    document.getElementById("ai-copilot-chat").classList.toggle("show");
};

document.getElementById("close-chat").onclick = function() {
    document.getElementById("ai-copilot-chat").classList.remove("show");
};

document.getElementById("user-input").onkeypress = function(e) {
    if (e.key === "Enter" && this.value.trim() !== "") {
        var userText = "<div>User: " + this.value + "</div>";
        document.getElementById("chat-messages").innerHTML += userText;
        askCopilot(this.value); 
        this.value = ""; 
    }
};
